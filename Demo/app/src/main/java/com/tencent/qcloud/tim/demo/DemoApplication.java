...
public class DemoApplication extends Application {
    ...
    public void onCreate() {
        ...
        /*Log.e("TAG", "getFilesDir" + this.getFilesDir().toString());
    ...
    private void OtherProcessOnCreate() {
        ...
        serviceInitializer.onCreate(this);

        TUIChatService tuiChatService = new TUIChatService();
        tuiChatService.onCreate(this);

        TUIConversationService tuiConversationService = new TUIConversationService();
        tuiConversationService.onCreate(this);

        TUIContactService tuiContactService = new TUIContactService();
        tuiContactService.onCreate(this);
    }
    ...
    private boolean isMainProcess() {
        ...
        if (processInfos == null) {
            ...
            for (ActivityManager.RunningServiceInfo rsi : processList) {
                Log.i(TAG, "rsi.service.getPackageName() = " + rsi.service.getPackageName());
        ...
        for (ActivityManager.RunningAppProcessInfo info : processInfos) {
            Log.i(TAG, "info.processName = " + info.processName);
