...
public class GenerateTestUserSig {
    ...
    public static final int OTHER_SDKAPPID = 0;
    ...
    private static final String OTHER_SECRETKEY = "";
     ...
     * Reference: https://intl.cloud.tencent.com/document/product/1047/34385
     */
    public static String genTestUserSig(String userId, boolean isOther) {
        if (isOther) {
            return GenTLSSignature(OTHER_SDKAPPID, userId, EXPIRETIME, null, OTHER_SECRETKEY);
        } else {
